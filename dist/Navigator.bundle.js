(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.Navigator = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
/*
...
},{"lodash._baseclone":3,"lodash._root":4,"lodash.isplainobject":7,"lodash.keysin":8,"lodash.mergewith":9,"lodash.rest":10}],7:[function(require,module,exports){
/**
...
},{"lodash._baseclone":3,"lodash._root":4,"lodash.isplainobject":7,"lodash.keysin":8,"lodash.rest":10}],10:[function(require,module,exports){
/**
 * lodash (Custom Build) <https://lodash.com/>
 * Build: `lodash modularize exports="npm" -o ./`
 * Copyright jQuery Foundation and other contributors <https://jquery.org/>
...
},{"lodash.debounce":5}],12:[function(require,module,exports){
'use strict';
...
var Navigator = function () {
    function Navigator(options) {
        ...
        this.options = (0, _lodash6.default)(options, defaults);
    ...
    Navigator.prototype.initiateData = function initiateData() {
        ...
        this.pageLinks.map(function (link, index) {
            ...
            _this2.data.push({
                index: index,
                id: link.id,
                node: document.querySelector('a[href="#' + _this2.pageLinks[index].id + '"]')
            });
    ...
    Navigator.prototype.toggleActiveClasses = function toggleActiveClasses() {
        ...
        if (this.options.defaultIndex - 1 > this.activeState.active) {
            ...
            this.state.map(function (item, index) {
                if (index !== _this4.activeState.active) {
                    _this4.removeClass(_this4.data[index].node);
                } else {
                    _this4.addClass(_this4.data[index].node);
                }
            });
        }
    };
...
},{"classlist-polyfill":1,"element-closest":2,"lodash.debounce":5,"lodash.defaultsdeep":6,"lodash.throttle":11}]},{},[12])(12)
});